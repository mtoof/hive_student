...
#    Updated: 2022/11/08 12:04:52 by mtoof            ###   ########.fr        #
#                                                                              #
# **************************************************************************** #
...
SRC = ft_bzero.c ft_isalnum.c ft_isalpha.c ft_isascii.c ft_isdigit.c	\
		...
		ft_putendl_fd.c ft_strtrim.c ft_strmapi.c ft_split.c ft_itoa.c ft_striteri.c
OBJ = ft_bzero.o ft_isalnum.o ft_isalpha.o ft_isascii.o ft_isdigit.o	\
		...
		ft_putendl_fd.o ft_strtrim.o ft_strmapi.o ft_split.o ft_itoa.o ft_striteri.o
HEADER = libft.h
